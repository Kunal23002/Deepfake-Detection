...
efficientnetb0_weights = torch.load(
    r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\efficientnet-b0.pth",
    map_location=torch.device(device),
)
xceptionnet_weights = torch.load(
    r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\xception-net.pth",
    map_location=torch.device(device),
)
efficientnetb7_weights = torch.load(
    r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\efficientnet-b7.pth",
    map_location=torch.device(device),
)
ppg_weights = torch.load(
    r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\ppg.pth",
    map_location=torch.device(device),
)
...
ensemble_model.load_state_dict(
    torch.load(
        r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\ensemble_model.pth",
...
if st.session_state.page == "Home":
    ...
    image_paths = [
        r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\image1.jpg",
        r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\image2.jpg",
        r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\image3.jpg",
    ]
...
if st.session_state.page == "Contact":
    ...
    right_image = Image.open(
        r"C:\Users\Kuval Garg\Desktop\PES\Capstone\Source Code\5_deployment\developer.jpg"
    )
